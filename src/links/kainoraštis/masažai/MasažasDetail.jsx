...
function MasažasDetail() {
  ...
  return (
    <div
      className="masazas-detail-section"
          ...
          <div className="masazas-text-container">
            <div className="masazas-text-box-detail">
              <div className="masazas-info">
                <p>
                  <strong>Trukmė:</strong> {massage.duration}
                </p>
                <p>
                  <strong>Kaina:</strong> {massage.price}
                </p>
              </div>
              <h3 className="masazas-text-content">
                Masažas man nėra tik technika – tai menas išgirsti kūną.
                Kiekvienas žmogus atsineša savą istoriją, o per prisilietimą aš
                padedu jam išlaisvinti įtampą, paleisti emocijas ir sugrįžti į
                vidinę pusiausvyrą. Mano tikslas – ne tik atpalaiduoti kūną, bet
                ir sušvelninti sielą.
              </h3>
            </div>
            <div className="masazas-back-button-container">
              <Link to="/Karina-website/" className="back-link">
                Grįžti į pradžią
              </Link>
            </div>
          </div>
